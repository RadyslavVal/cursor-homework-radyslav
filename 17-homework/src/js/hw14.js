...
const _imgBase = 'https://starwars-visualguide.com/assets/img';
...
const getWookieeFilm = async (id) => {
    const film = await getWookieeAllFilms(id);
    return _transformFilm(film);
}

const getWookieeAllFilms = async (id = '') => {
